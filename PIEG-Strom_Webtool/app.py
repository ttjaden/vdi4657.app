                ...
                children=[dbc.Container(
                    ...
                    dbc.Row(
                        ...
                        dbc.Col(html.Div(id='scroll',children=[
                            dcc.Tabs(id='tabs',value='what-is'),
...
def change_language(n_language):
    ...
    return ([DashIconify(icon=flag, width=30,height=30,),language.loc[language['name']=='lang',lang].iloc[0]],lang,
                ...
                [dcc.Tab(label='Info',value='what-is',children=[html.Div(children=[
                ...
                dcc.Tab(label='Parameter',value='parameter',),
                dcc.Tab(id='tab_economy',label=language.loc[language['name']=='economics',lang].iloc[0], value='economics',)]
        )
...
def getcontainer(efh_click,mfh_click,industry_click,choosebuilding,lang):
    ...
    if industry_click is None:
        industry_click=0
    if efh_click>mfh_click:
        if efh_click>industry_click:
                    ...
                    [
                        dbc.Row(
                            ...
                            dbc.Col(html.Div(children=[
                                ...
                                html.Div(id='region'),
                                html.Div(language.loc[language['name']=='building_type',lang].iloc[0]),
    ...
    elif mfh_click>efh_click:
        if mfh_click>industry_click:
            return (MFH_container,
                {'background-color': 'white','color': 'black'},
                {'background-color': '#212529','color': 'white',},
                {'background-color': 'white','color': 'black'},'mfh')
    elif industry_click>efh_click:
        if industry_click>mfh_click:
            return (Industrie_container,
                {'background-color': 'white','color': 'black'},
                {'background-color': 'white','color': 'black'},
